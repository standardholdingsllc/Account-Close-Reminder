  ...
  try {
    ...
    for (const account of negativeAccounts) {
      try {
        ...
        console.log(`Checking account ${accountId} with balance $${balance}`);
        ...
        console.log(`Account ${accountId}: ${daysSinceLastActivity} days since last transaction (${lastTransactionDate.toLocaleDateString()}), balance: $${balance}`);
